...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFE66E15);
  late Color secondary = const Color(0xFF4A4747);
  late Color tertiary = const Color(0xFFECAB66);
  late Color alternate = const Color(0xFF9C5022);
  late Color primaryText = const Color(0xFF57636C);
  late Color secondaryText = const Color(0xFF101213);
  late Color primaryBackground = const Color(0xFFD9D9D9);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFECAB66);
  late Color alternate = const Color(0xFF9C5022);
  late Color primaryText = const Color(0xFFD9D9D9);
